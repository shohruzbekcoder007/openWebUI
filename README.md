...
- **Hermes Agents** — configured in `config/agents.yaml` (Qishloq xo'jaligi, GIS, Statistics, Press reliz, Metodologiya agenti, Programmer, Translator, …)
...
You should see **Qishloq xo'jaligi**, **GIS**, **Statistics**, **Press reliz**, **Metodologiya agenti**, **Programmer**, **Translator**.
